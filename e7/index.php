...
<body>
	<form method="get" action="index2.php"><!--ENVIA LOS VALORES DEL FORMULARIO MEDIANTE LA URL A LA PAGINA ejercicio7-1.php-->
	<table width="258" border="0">
		<tr>
			<td colspan="2"><strong>ejercicio 7</strong></td>
		</tr>
		<tr>
